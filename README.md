...
With a focus on performance, maintainability, security, and user experience, I have delivered diverse software products from e-commerce platforms to robust management systems.
...
- API Integration, Debugging & Troubleshooting, Modular Architecture, Component-Based Design
- Git, GitHub
...
- Department: Information Systems (GPA: 3.07/4 - Very Good)
...
<!--
**Omar11dev/Omar11dev** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
-->
